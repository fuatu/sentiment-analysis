...
# if want to install without docker and run locally use localhost instead of db
# example mysql+pymysql://octotest:Q1x2v4c5@localhost/octopus
engine = create_engine('mysql+pymysql://root:password@db/octopus', pool_recycle=3600)
